...
public  class Src_CEConnection {
	...
	public	static Connection get_Connection(){
		...
		try{
			...
			connection=Factory.Connection.getConnection(tgtProps.getString("src_uri"));

			userContext=UserContext.get();

			subject = UserContext.createSubject(connection, tgtProps.getString("src_username"), tgtProps.getString("src_password"), null);
	...
	public static ObjectStore get_ObjectStore(){
		...
		objectStore = Factory.ObjectStore.fetchInstance(domain,tgtProps.getString("src_objectstorename"),null);
		}
		return objectStore;
